...
export const STORIES: StoryMilestone[] = [
  {
    flowerId: 1,
    x: 220,
    text: 'Ngày hôm ấy, trời chẳng nắng cũng chẳng mưa... Nhưng khoảnh khắc cậu quay đầu lại cười, thế giới của mình tự nhiên có màu.',
  },
  {
    flowerId: 2,
    x: 450,
    text: 'Cậu từng bảo cậu thích những điều giản dị như ngắm một chú mèo ngủ ngoan... Còn mình, mình chỉ thích nhìn cậu kể về những điều giản dị ấy với đôi mắt lấp lánh.',
  },
  {
    flowerId: 3,
    x: 850,
    text: 'Có những đêm nằm nghe tiếng mưa rơi, mình mở lại từng dòng tin nhắn cũ... Đọc từng câu chữ ngốc nghếch rồi tự cười một mình. Hóa ra nhớ một người là cảm giác như thế.',
  },
  {
    flowerId: 4,
    x: 1150,
    text: 'Những ngày lòng mình nhiều mây đen và giông bão nhất... Chỉ cần nghĩ đến việc có cậu ở phía trước, mọi mỏi mệt bỗng chốc hóa dịu dàng.',
  },
  {
    flowerId: 5,
    x: 1500,
    text: 'Cậu từng bảo ánh sáng đom đóm quá đỗi mong manh... Nhưng cậu biết không, đôi khi chỉ cần một đốm sáng nhỏ nơi ánh mắt cậu, cũng đủ để mình không bao giờ lạc đường.',
  },
  {
    flowerId: 6,
    x: 1750,
    text: 'Mỗi bản nhạc mình nghe, mỗi góc phố mình từng đi qua... Bằng một cách kỳ diệu nào đó, tâm trí mình đều vô thức dẫn về phía cậu.',
  },
  {
    flowerId: 7,
    x: 2100,
    text: 'Và bông hoa này... là tất cả dũng khí mình gom góp bấy lâu nay. Để hôm nay, mình có thể đứng trước mặt cậu mà không còn ngập ngừng.',
  },
];
...
export const LETTER_FRAGMENTS: LetterFragmentData[] = [
  {
    ...
    excerpt: 'Cậu có nhớ lần đầu tiên chúng mình ngồi trú mưa ở hiên quán cũ không? Cậu chia cho mình nửa chiếc bánh quy, còn mình thì lúng túng chẳng dám nhìn thẳng vào mắt cậu...',
  ...
  },
  {
    ...
    excerpt: 'Có những đêm nghe cậu thở dài vì mệt mỏi, mình chỉ ước có thể mang cho cậu một ly trà ấm. Mình sợ sự vụng về làm phiền cậu, nên chỉ biết lặng lẽ thức cùng cậu...',
  ...
  },
  {
    ...
    excerpt: 'Hôm nay, mình gom hết tất cả sự can đảm tích cóp từ những ngày tháng ngắm nhìn cậu từ xa. Nếu không bước đến nói thật lòng mình, mình sẽ hối tiếc cả đời...',
